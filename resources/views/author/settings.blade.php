    ...
    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#image" data-toggle="tab">Image Full View</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <h4>Profile Information</h4>
                                   <form role="form" action="{{ route('author.profile.update') }}" method="POST" enctype="multipart/form-data">
                                       @csrf
                                       @method('PUT')
                            ...
                            <button type="submit" class="btn btn-primary m-t-15 waves-effect">UPDATE</button>
                                ...
                                <div class="tab-pane fade" id="settings">
                                  ...
                                  <form role="form" action="{{ route('author.password.update') }}" method="POST">
                                       @csrf
                                       @method('PUT')
                                        <div class="form-group">
